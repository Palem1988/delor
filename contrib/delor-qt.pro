...
RESOURCES += src/qt/delor.qrc src/qt/delor_locale.qrc

TRANSLATIONS += src/qt/locale/delor_bg.ts \
                src/qt/locale/delor_de.ts \
                src/qt/locale/delor_en.ts \
                src/qt/locale/delor_es.ts \
                src/qt/locale/delor_fi.ts \
                src/qt/locale/delor_fr.ts \
                src/qt/locale/delor_it.ts \
                src/qt/locale/delor_ja.ts \
                src/qt/locale/delor_pl.ts \
                src/qt/locale/delor_pt.ts \
                src/qt/locale/delor_ru.ts \
                src/qt/locale/delor_sk.ts \
                src/qt/locale/delor_sv.ts \
                src/qt/locale/delor_vi.ts \
                src/qt/locale/delor_zh_CN.ts \
                src/qt/locale/delor_zh_TW.ts

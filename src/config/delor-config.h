/* src/config/delor-config.h.  Generated from delor-config.h.in by configure.  */
/* src/config/delor-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://delor.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Delor Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Delor Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "delor"

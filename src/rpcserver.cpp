...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DLR features */
        {"delor", "masternode", &masternode, true, true, false},
        {"delor", "masternodelist", &masternodelist, true, true, false},
        {"delor", "mnbudget", &mnbudget, true, true, false},
        {"delor", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"delor", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"delor", "mnsync", &mnsync, true, true, false},
        {"delor", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"delor", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use delord, or the -server option to delor-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Delor Alert\" admin@foo.com\n"),
...
{
    return "> delor-cli " + methodname + " " + args + "\n";
}

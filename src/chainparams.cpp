...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000002e7bdf64609686d8d4215f8183e9f4130b816218bdc09641616d453dd4"))
    (357147, uint256("0x4f6b99ffa32cd3829816deee5dab96c1f2e8027ca42b316272f0765ad811333b"))
    (382953, uint256("0x708ec2e92f4ac5514d6ccb6d5caf1774ebd612501810959e40fed99c3f52f345"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1550352927, // * UNIX timestamp of last checkpoint block
    783609,    // * total number of transactions between genesis and last checkpoint
...
public:
	...
	nMasternodeColleteralLimxDev = 6000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Delor cryptocurrency";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1527229400;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20881759;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x0000002e7bdf64609686d8d4215f8183e9f4130b816218bdc09641616d453dd4"));
	...
	vSeeds.push_back(CDNSSeedData("104.248.244.214", "104.248.244.214"));
        ...
        nStartMasternodePayments = 1527229400; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1527229401;
        genesis.nNonce = 20595815;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000be6eaf604681d9d79880b6417007ff5d390493723724b3397b9d25344cb"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Delor BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Delor BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Delor BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1527229401;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1527229402;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 2;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x1ce840abfff03757b642abc59528b0f42d8c4082d97502f7a24e6bfdd6b457bc"));

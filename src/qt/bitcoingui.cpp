                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Delor-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Delor address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and delor: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Delor Core"), this);
    aboutAction->setStatusTip(tr("Show information about Delor Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Delor"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Delor addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Delor addresses"));
    ...
    openAction->setStatusTip(tr("Open a Delor: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Delor Core help message to get a list with possible Delor command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Delor Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Delor network", "", count));
}
...
{
    QString strTitle = tr("Delor Core"); // default title

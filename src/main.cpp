...
#if defined(NDEBUG)
#error "Delor cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Delor Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 3200 ) {
	        nSubsidy = 1 * COIN;
	}else if( nHeight > 3200 && nHeight <= 6000 ) {
	        nSubsidy = 50 * COIN;
	}else if( nHeight > 6000 && nHeight <= 14000 ) {
	        nSubsidy = 100 * COIN;
	}else if( nHeight > 14000 && nHeight <= 32000 ) {
	        nSubsidy = 220 * COIN;
	}else if( nHeight > 32000 && nHeight <= 48000 ) {
	        nSubsidy = 160 * COIN;
	}else if( nHeight > 48000 && nHeight <= 400000 ) {
	        nSubsidy = 100 * COIN;
